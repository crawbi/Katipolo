( () => {
    "use strict";
    var t, e = Object.defineProperty, r = (t, r, n) => (( (t, r, n) => {
        r in t ? e(t, r, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
    ...
    , a = class {
        constructor() {
            r(this, "_lastHandleId", 0),
            r(this, "_lastImmediate", null)
        }
        requestAnimationFrame(t) {
    ...
    , o = class {
        constructor() {
            r(this, "_strategy"),
            this._strategy = "function" == typeof requestAnimationFrame ? new n : new a
        }
        requestAnimationFrame(t) {
    ...
    , i = typeof window < "u" && typeof window.document < "u", s = "@lottiefiles/dotlottie-web", u = "0.24.0", l = (t = typeof document < "u" ? document.currentScript?.src : void 0,
    function(e={}) {
        var r, n, a = e, o = new Promise(( (t, e) => {
            r = t,
            n = e
        }
        )), i = Object.assign({}, a), s = "./this.program", u = "";
        typeof document < "u" && document.currentScript && (u = document.currentScript.src),
        t && (u = t),
        u = u.startsWith("blob:") ? "" : u.substr(0, u.replace(/[?#].*/, "").lastIndexOf("/") + 1);
        var l, c = a.print || console.log.bind(console), d = a.printErr || console.error.bind(console);
        Object.assign(a, i),
        i = null,
        ...
        var M, S, E = t => t.startsWith("data:application/octet-stream;base64,");
        function k(t) {
            if (t == M && l)
        ...
        function j(t, e, r) {
            return function(t) {
                return l || "function" != typeof fetch ? Promise.resolve().then(( () => k(t))) : fetch(t, {
            ...
            }(t).then((t => WebAssembly.instantiate(t, e))).then(r, (t => {
                d(`failed to asynchronously prepare wasm: ${t}`),
                A(t)
            }
            ))
        }
        E(M = "DotLottiePlayer.wasm") || (S = M,
        M = a.locateFile ? a.locateFile(S, u) : u + S);
        var D = t => {
            for (; t.length > 0; )
                t.shift()(a)
        }
        ...
        var W = t => Ce(t)
          ...
          , O = (t, e, r) => {
            for (var n = e + r, a = e; t[a] && !(a >= n); )
                ++a;
            if (a - e > 16 && t.buffer && R)
                return R.decode(t.subarray(e, a));
            for (var o = ""; e < a; ) {
                var i = t[e++];
                if (128 & i) {
                    var s = 63 & t[e++];
                    if (192 != (224 & i)) {
                        var u = 63 & t[e++];
                        if ((i = 224 == (240 & i) ? (15 & i) << 12 | s << 6 | u : (7 & i) << 18 | s << 12 | u << 6 | 63 & t[e++]) < 65536)
        ...
        var q = t => we(t)
          ...
          , z = (t, e, r, n) => {
            ...
            for (var a = r, o = r + n - 1, i = 0; i < t.length; ++i) {
                ...
                if (s >= 55296 && s <= 57343 && (s = 65536 + ((1023 & s) << 10) | 1023 & t.charCodeAt(++i)),
                s <= 127) {
                    if (r >= o)
                        break;
                    e[r++] = s
        ...
        , et = (t, e, r) => {
            ...
            var a = new Array(e.length)
              ...
              , i = 0;
            e.forEach(( (t, e) => {
                K.hasOwnProperty(t) ? a[e] = K[t] : (o.push(t),
        ...
        function at(t, e, r={}) {
            ...
            return function(t, e, r={}) {
                var n = e.name;
                if (t || nt(`type "${n}" must have a positive integer typeid pointer`),
                K.hasOwnProperty(t)) {
        ...
        , ft = {}, yt = (t, e) => ((!e.ptrType || !e.ptr) && tt("makeClassHandle requires ptr and ptrType"),
        !!e.smartPtrType != !!e.smartPtr && tt("Both smartPtrType and smartPtr must be specified"),
        e.count = {
            value: 1
        },
        gt(Object.create(t, {
        ...
        var gt = t => typeof FinalizationRegistry > "u" ? (gt = t => t,
        t) : (ut = new FinalizationRegistry((t => {
            ct(t.$$)
        }
        )),
        ...
        function vt() {}
        var _t = (t, e) => Object.defineProperty(e, "name", {
            value: t
        })
          , wt = (t, e, r) => {
            if (void 0 === t[e].overloadTable) {
                var n = t[e];
                t[e] = function(...n) {
                    return t[e].overloadTable.hasOwnProperty(n.length) || nt(`Function '${r}' called with an invalid number of arguments (${n.length}) - expects one of (${t[e].overloadTable})!`),
          ...
          , Ct = (t, e, r) => {
            a.hasOwnProperty(t) ? ((void 0 === r || void 0 !== a[t].overloadTable && void 0 !== a[t].overloadTable[r]) && nt(`Cannot register public name '${t}' twice`),
            wt(a, t, t),
            a.hasOwnProperty(r) && nt(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`),
            a[t].overloadTable[r] = e) : (a[t] = e,
            void 0 !== r && (a[t].numArguments = r))
        }
        ;
        ...
        var bt = (t, e, r) => {
            for (; e !== r; )
                e.upcast || nt(`Expected null or instance of ${r.name}, got an instance of ${e.name}`),
                t = e.upcast(t),
                e = e.baseClass;
            return t
        }
        ...
        function Ft(t, e) {
            if (null === e)
                return this.isReference && nt(`null is not a valid ${this.name}`),
                0;
            e.$$ || nt(`Cannot pass "${Nt(e)}" as a ${this.name}`),
            e.$$.ptr || nt(`Cannot pass deleted object as a pointer of type ${this.name}`);
        ...
        function Lt(t, e) {
            ...
            e.$$.ptr || nt(`Cannot pass deleted object as a pointer of type ${this.name}`),
            !this.isConst && e.$$.ptrType.isConst && nt(`Cannot convert argument of type ${e.$$.smartPtrType ? e.$$.smartPtrType.name : e.$$.ptrType.name} to parameter type ${this.name}`);
            var n = e.$$.ptrType.registeredClass;
            if (r = bt(e.$$.ptr, n, this.registeredClass),
            this.isSmartPointer)
                switch (void 0 === e.$$.smartPtr && nt("Passing raw pointer to smart pointer is illegal"),
                this.sharingPolicy) {
                case 0:
                    e.$$.smartPtrType === this ? r = e.$$.smartPtr : nt(`Cannot convert argument of type ${e.$$.smartPtrType ? e.$$.smartPtrType.name : e.$$.ptrType.name} to parameter type ${this.name}`);
                    break;
                case 1:
                    r = e.$$.smartPtr;
                    break;
                case 2:
                    if (e.$$.smartPtrType === this)
                        ...
                        var a = e.clone();
                        r = this.rawShare(r, qt.toHandle(( () => a.delete()))),
                        null !== t && t.push(this.rawDestructor, r)
                    }
                    break;
                default:
        ...
        function Pt(t, e) {
            ...
            e.$$ || nt(`Cannot pass "${Nt(e)}" as a ${this.name}`),
            e.$$.ptr || nt(`Cannot pass deleted object as a pointer of type ${this.name}`),
            e.$$.ptrType.isConst && nt(`Cannot convert argument of type ${e.$$.ptrType.name} to parameter type ${this.name}`);
            var r = e.$$.ptrType.registeredClass;
            return bt(e.$$.ptr, r, this.registeredClass)
        }
        function Tt(t, e, r, n, a, o, i, s, u, l, c) {
            ...
            a || void 0 !== e.baseClass ? this.toWireType = Lt : n ? (this.toWireType = Ft,
            this.destructorFunction = null) : (this.toWireType = Pt,
            this.destructorFunction = null)
        }
        var At, Mt, St = (t, e, r) => {
            a.hasOwnProperty(t) || tt("Replacing nonexistent public symbol"),
            void 0 !== a[t].overloadTable && void 0 !== r ? a[t].overloadTable[r] = e : (a[t] = e,
            a[t].argCount = r)
        }
        , Et = t => At.get(t), kt = (t, e) => {
            var r = (t = rt(t)).includes("j") ? ( (t, e) => (...r) => ( (t, e, r=[]) => t.includes("j") ? ( (t, e, r) => (t = t.replace(/p/g, "i"),
            (0,
            a["dynCall_" + t])(e, ...r)))(t, e, r) : Et(e)(...r))(t, e, r))(t, e) : Et(e);
            return "function" != typeof r && nt(`unknown function pointer with signature ${t}: ${e}`),
            r
        }
        , jt = t => {
            var e = ge(t)
        ...
        function It(t, e, r, n, a, o) {
            var i = e.length;
            i < 2 && nt("argTypes array size mismatch! Must at least get return value and 'this' types!");
            ...
            return _t(t, (function(...r) {
                var o;
                r.length !== c && nt(`function ${t} called with ${r.length} arguments, expected ${c}`),
                m.length = 0,
                h.length = s ? 2 : 1,
                h[0] = a,
                s && (o = e[1].toWireType(m, this),
                h[1] = o);
                for (var i = 0; i < c; ++i)
                    d[i] = e[i + 2].toWireType(m, r[i]),
                    h.push(d[i]);
                return function(t) {
                    if (u)
                        Y(m);
                        ...
                        for (var r = s ? 1 : 2; r < e.length; r++) {
                            var n = 1 === r ? o : d[r - 2];
                            null !== e[r].destructorFunction && e[r].destructorFunction(n)
                        }
                    if (l)
                        return e[0].fromWireType(t)
                }(n(...h))
            }
            ))
        }
        ...
        , xt = [], Ut = [], Ht = t => {
            t > 9 && 0 == --Ut[t + 1] && (Ut[t] = void 0,
            xt.push(t))
        }
        , qt = {
            toValue: t => (t || nt("Cannot use deleted val. handle = " + t),
            Ut[t]),
            toHandle: t => {
                switch (t) {
                case void 0:
        ...
        , Yt = (t, e) => {
            var r = K[t];
            return void 0 === r && nt(`${e} has unknown type ${jt(t)}`),
            r
        }
        , Nt = t => {
            if (null === t)
        ...
        , Xt = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, Zt = (t, e) => {
            for (var r = t, n = r >> 1, a = n + e / 2; !(n >= a) && y[n]; )
                ++n;
            if ((r = n << 1) - t > 32 && Xt)
                return Xt.decode(p.subarray(t, r));
        ...
        , Kt = (t, e, r) => {
            ...
            r < 2)
                return 0;
            for (var n = e, a = (r -= 2) < 2 * t.length ? r / 2 : t.length, o = 0; o < a; ++o) {
        ...
        , ee = (t, e, r) => {
            ...
            for (var n = e, a = n + r - 4, o = 0; o < t.length; ++o) {
                var i = t.charCodeAt(o);
                if (i >= 55296 && i <= 57343 && (i = 65536 + ((1023 & i) << 10) | 1023 & t.charCodeAt(++o)),
                g[e >> 2] = i,
                (e += 4) + 4 > a)
                    break
            }
        ...
        var oe = t => {
          ...
          , se = () => {
            if (!se.strings) {
                ...
                for (var e in ie)
                    void 0 === ie[e] ? delete t[e] : t[e] = ie[e];
                var r = [];
                for (var e in t)
                    r.push(`${e}=${t[e]}`);
                se.strings = r
        ...
        G = a.InternalError = class extends Error {
            constructor(t) {
                super(t),
        ...
        X = a.BindingError = class extends Error {
            constructor(t) {
                super(t),
        ...
        Object.assign(vt.prototype, {
            isAliasOf(t) {
                if (!(this instanceof vt && t instanceof vt))
                    return !1;
            ...
            clone() {
                ...
                this.$$.preservePointerOnDelete)
                    ...
                    this;
                var t = gt(Object.create(Object.getPrototypeOf(this), {
                    $$: {
                        value: it(this.$$)
                    }
                }));
            ...
            delete() {
                this.$$.ptr || st(this),
                this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && nt("Object already scheduled for deletion"),
                lt(this),
                ct(this.$$),
        ...
        a.getLiveInheritedInstances = () => {
            var t = [];
            for (var e in ft)
                ft.hasOwnProperty(e) && t.push(ft[e]);
            return t
        }
        ,
        ...
        Object.assign(Tt.prototype, {
            ...
            fromWireType: function(t) {
                ...
                if (!e)
                    ...
                    null;
                var r = ( (t, e) => (e = ( (t, e) => {
                    for (void 0 === e && nt("ptr should not be undefined"); t.baseClass; )
                        e = t.upcast(e),
                        t = t.baseClass;
                    return e
                }
                )(t, e),
                ft[e]))(this.registeredClass, e);
                if (void 0 !== r) {
                    if (0 === r.$$.count.value)
                        return r.$$.ptr = e,
                        r.$$.smartPtr = t,
                ...
                function a() {
                    return this.isSmartPointer ? yt(this.registeredClass.instancePrototype, {
                ...
                var o, i = this.registeredClass.getActualType(e), s = ht[i];
                if (!s)
                    return a.call(this);
                o = this.isConst ? s.constPointerType : s.pointerType;
                var u = dt(e, this.registeredClass, o.registeredClass);
                return null === u ? a.call(this) : this.isSmartPointer ? yt(o.registeredClass.instancePrototype, {
                    ptrType: o,
                    ptr: u,
                    smartPtrType: this,
                    smartPtr: t
        ...
        var pe = {
            c: (t, e, r, n) => {
                A(`Assertion failed: ${x(t)}, at: ` + [e ? x(e) : "unknown filename", r, n ? x(n) : "unknown function"])
            }
            ,
            d: () => (t => {
                var e = U;
            ...
            A: t => {
                ...
                var r = e.rawConstructor
                  , n = e.rawDestructor
                  , a = e.fields
                  , o = a.map((t => t.getterReturnType)).concat(a.map((t => t.setterArgumentType)));
                et([t], o, (t => {
                    var o = {};
            ...
            z: (t, e, r, n, a, o, i, s, u, l, c, d, h) => {
                ...
                et([t, e, r], n ? [n] : [], (e => {
                    var r, a, i;
                    e = e[0],
                    i = n ? (a = e.registeredClass).instancePrototype : vt.prototype;
                    var u = _t(c, (function(...t) {
                        ...
                        if (void 0 === e)
                            throw new X(`Tried to invoke ctor of ${c} with invalid number of parameters (${t.length}) - expected (${Object.keys(p.constructor_body).toString()}) parameters instead!`);
                    ...
                    p.baseClass && ((r = p.baseClass).__derivedClasses ?? (r.__derivedClasses = []),
            ...
            x: (t, e, r, n, a, o) => {
                ...
                et([], [t], (t => {
                    ...
                    void 0 !== t.registeredClass.constructor_body[e - 1])
                        throw new X(`Cannot register multiple constructors with identical number of parameters (${e - 1}) for class '${t.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
                    return t.registeredClass.constructor_body[e - 1] = () => {
                        Dt(`Cannot construct ${t.name} due to unbound types`, i)
                    }
                    ,
                    et([], i, (n => (n.splice(1, 0, null),
                    t.registeredClass.constructor_body[e - 1] = It(r, n, null, a, o),
                    []))),
                    []
                }
                ))
            ...
            i: (t, e, r, n, a, o, i, s, u) => {
                ...
                et([], [t], (t => {
                    ...
                    var u = t.registeredClass.instancePrototype
                      , c = u[e];
                    return void 0 === c || void 0 === c.overloadTable && c.className !== t.name && c.argCount === r - 2 ? (a.argCount = r - 2,
                    a.className = t.name,
                    u[e] = a) : (wt(u, e, n),
                    u[e].overloadTable[r - 2] = a),
                    et([], l, (a => {
                        var s = It(n, a, t, o, i);
                        return void 0 === u[e].overloadTable ? (s.argCount = r - 2,
                        u[e] = s) : u[e].overloadTable[r - 2] = s,
                        []
                    }
                    )),
                    []
            ...
            J: (t, e) => {
                ...
                at(t, {
                    ...
                    toWireType(t, e) {
                        ...
                        var n, a = "string" == typeof e;
                        a || e instanceof Uint8Array || e instanceof Uint8ClampedArray || e instanceof Int8Array || nt("Cannot pass non-string to std::string"),
                        n = r && a ? V(e) : e.length;
                        var o = ye(4 + n + 1)
                          , i = o + 4;
                        if (v[o >> 2] = n,
                        r && a)
                            ...
                            for (var s = 0; s < n; ++s) {
                                ...
                                u > 255 && (ve(i),
                                nt("String has UTF-16 code units that do not fit in 8 bits")),
                                p[i + s] = u
                            }
                        else
                            for (s = 0; s < n; ++s)
                                p[i + s] = e[s];
                        return null !== t && t.push(ve, o),
                        o
                    },
                    argPackAdvance: 8,
                    readValueFromPointer: N,
            ...
            y: (t, e, r) => {
                ...
                at(t, {
                    ...
                    ,
                    toWireType: (t, n) => {
                        "string" != typeof n && nt(`Cannot pass non-string to C++ string type ${r}`);
                        var o = i(n)
                          , s = ye(4 + o + e);
                        return v[s >> 2] = o / e,
                        a(n, s + 4, o + e),
            ...
            ha: (t, e, r) => {
                ...
                return (t => {
                    ...
                    return ( (t, e, r) => {
                        var n = []
                          , a = t.toWireType(n, r);
                        return n.length && (v[e >> 2] = qt.toHandle(n)),
                        a
                    }
                    )(a, s, d)
                }
            ...
            l: Rt,
            S: t => {
                var e, r = p.length, n = 2147483648;
                if ((t >>>= 0) > n)
                    return !1;
                for (var a = 1; a <= 4; a *= 2) {
                    var o = r * (1 + .2 / a);
                    o = Math.min(o, t + 100663296);
                    var i = Math.min(n, (e = Math.max(t, o)) + (65536 - e % 65536) % 65536);
                    if (oe(i))
                        return !0
                }
                return !1
            ...
            _: (t, e) => {
                ...
                v[t >> 2] = r.length;
                var n = 0;
                return r.forEach((t => n += t.length + 1)),
                v[e >> 2] = n,
                0
            }
            ,
            ...
            Q: (t, e, r, n, a) => ( (t, e, r, n) => {
                ...
                function y(t) {
                    var e = ( (t, e) => {
                      ...
                      , a = f(r)
                      , o = f(n);
                    return p(a, e) <= 0 ? p(o, e) <= 0 ? e.getFullYear() + 1 : e.getFullYear() : e.getFullYear() - 1
                }
                var _ = {
                    ...
                    )(de(t.tm_year + 1900) ? he : me, t.tm_mon - 1), 3),
                    "%m": t => h(t.tm_mon + 1, 2),
                    "%M": t => h(t.tm_min, 2),
                    "%n": () => "\n",
                    ...
                    "%V": t => {
                        ...
                        if ((t.tm_wday + 371 - t.tm_yday - 2) % 7 <= 2 && e++,
                        e) {
                            if (53 == e) {
                    ...
                    "%z": t => {
                        var e = t.tm_gmtoff;
                        return (e >= 0 ? "+" : "-") + ("0000" + (e = (e = Math.abs(e) / 60) / 60 * 100 + e % 60)).slice(-4)
                    }
                    ,
                    "%Z": t => t.tm_zone,
                    "%%": () => "%"
                ...
                var w = function(t, e, r) {
                    var n = V(t) + 1
                      , a = new Array(n);
                    return z(t, a, 0, a.length),
                    a
                }(i = i.replace(/\0\0/g, "%"));
                return w.length > e ? 0 : (( (t, e) => {
                    m.set(t, e)
                }
                )(w, t),
                w.length - 1)
          ...
          , fe = function() {
            ...
            return function(t, e, r, n) {
                return t || "function" != typeof WebAssembly.instantiateStreaming || E(e) || "function" != typeof fetch ? j(e, r, n) : fetch(e, {
                    credentials: "same-origin"
                }).then((t => WebAssembly.instantiateStreaming(t, r).then(n, (function(t) {
          ...
          , Fe = t => (Fe = fe.wa)(t);
        a.dynCall_iijj = (t, e, r, n, o, i) => (a.dynCall_iijj = fe.xa)(t, e, r, n, o, i),
        a.dynCall_vijj = (t, e, r, n, o, i) => (a.dynCall_vijj = fe.ya)(t, e, r, n, o, i),
        a.dynCall_jiii = (t, e, r, n) => (a.dynCall_jiii = fe.za)(t, e, r, n),
        a.dynCall_jii = (t, e, r) => (a.dynCall_jii = fe.Aa)(t, e, r);
        var Le, Pe = a.dynCall_viiij = (t, e, r, n, o, i) => (Pe = a.dynCall_viiij = fe.Ba)(t, e, r, n, o, i);
        function Te() {
            function t() {
                Le || (Le = !0,
                a.calledRun = !0,
            ...
            P > 0) || (a.setStatus ? (a.setStatus("Running..."),
            setTimeout((function() {
                setTimeout((function() {
                    a.setStatus("")
                }
        ...
        if (a.dynCall_jiji = (t, e, r, n, o) => (a.dynCall_jiji = fe.Ca)(t, e, r, n, o),
        a.dynCall_viijii = (t, e, r, n, o, i, s) => (a.dynCall_viijii = fe.Da)(t, e, r, n, o, i, s),
        a.dynCall_iiiiij = (t, e, r, n, o, i, s) => (a.dynCall_iiiiij = fe.Ea)(t, e, r, n, o, i, s),
        a.dynCall_iiiiijj = (t, e, r, n, o, i, s, u, l) => (a.dynCall_iiiiijj = fe.Fa)(t, e, r, n, o, i, s, u, l),
        a.dynCall_iiiiiijj = (t, e, r, n, o, i, s, u, l, c) => (a.dynCall_iiiiiijj = fe.Ga)(t, e, r, n, o, i, s, u, l, c),
        T = function t() {
            Le || Te(),
            Le || (T = t)
        }
        ...
        static async _loadWithBackup() {
            return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch((async t => {
                ...
                try {
                    ...
                    throw console.error(`Primary WASM URL failed: ${t.message}`),
    ...
    r(c, "_wasmURL", `https://cdn.jsdelivr.net/npm/${s}@${u}/dist/dotlottie-player.wasm`);
    var d = class {
        constructor() {
        ...
        addEventListener(t, e) {
            ...
            r || (r = new Set,
            this._eventListeners.set(t, r)),
            r.add(e)
        }
        removeEventListener(t, e) {
            let r = this._eventListeners.get(t);
            r && (e ? (r.delete(e),
            0 === r.size && this._eventListeners.delete(t)) : this._eventListeners.delete(t))
        }
        dispatch(t) {
      ...
      , h = (t, e) => "reverse" === t ? e.Mode.Reverse : "bounce" === t ? e.Mode.Bounce : "reverse-bounce" === t ? e.Mode.ReverseBounce : e.Mode.Forward
      , m = (t, e) => "contain" === t ? e.Fit.Contain : "cover" === t ? e.Fit.Cover : "fill" === t ? e.Fit.Fill : "fit-height" === t ? e.Fit.FitHeight : "fit-width" === t ? e.Fit.FitWidth : e.Fit.None
      , p = (t, e) => {
        let r = new e.VectorFloat;
        return r.push_back(t[0]),
        r.push_back(t[1]),
        r
    }
      , f = (t, e) => {
        let r = new e.VectorFloat;
        return 2 !== t.length || (r.push_back(t[0]),
        r.push_back(t[1])),
        r
    }
      , y = class {
        constructor(t) {
            ...
            c.load().then((e => {
                ...
                this._dotLottieCore = new e.DotLottiePlayer({
                    ...
                    marker: t.marker ?? "",
                    layout: t.layout ? {
                        align: p(t.layout.align, e),
                        fit: m(t.layout.fit, e)
        ...
        _loadFromSrc(t) {
            (async function() {
                let e = await fetch(t);
                if (!e.ok)
                    throw new Error(`Failed to fetch the animation data from URL: ${t}. ${e.status}: ${e.statusText}`);
                let r, n = (e.headers.get("content-type") ?? "").trim();
                return r = ["application/json", "text/plain"].some((t => n.startsWith(t))) ? await e.text() : await e.arrayBuffer(),
                r
            }
            )().then((t => {
                ...
                this._eventManager.dispatch({
                    type: "loadError",
                    error: new Error(`Failed to load animation data from URL: ${t}. ${e}`)
                })
            }
            ))
        }
        _loadFromData(t) {
            if (null === this._dotLottieCore)
                return;
            ...
            this._render(),
            this._dotLottieCore.config().autoplay && (this._dotLottieCore.play(),
        ...
        get mode() {
            ...
            return t === this._wasmModule?.Mode.Reverse ? "reverse" : t === this._wasmModule?.Mode.Bounce ? "bounce" : t === this._wasmModule?.Mode.ReverseBounce ? "reverse-bounce" : "forward"
        }
        get isFrozen() {
        ...
        load(t) {
            null === this._dotLottieCore || null === this._wasmModule || (this._dotLottieCore.setConfig({
                autoplay: t.autoplay ?? !1,
                backgroundColor: 0,
                loopAnimation: t.loop ?? !1,
        ...
        _render() {
            if (null === this._dotLottieCore || null === this._context)
                return !1;
            if (this._dotLottieCore.render()) {
                let t = this._dotLottieCore.buffer()
                  , e = new Uint8ClampedArray(t,0,this._canvas.width * this._canvas.height * 4)
                  , r = null;
                return typeof ImageData > "u" ? (r = this._context.createImageData(this._canvas.width, this._canvas.height),
                r.data.set(e)) : r = new ImageData(e,this._canvas.width,this._canvas.height),
        ...
        _draw() {
            if (null === this._dotLottieCore || null === this._context || !this._dotLottieCore.isPlaying())
                return;
        ...
        play() {
            ...
            this._isFrozen = !1,
            t && (this._eventManager.dispatch({
                type: "play"
            }),
            this._animationFrameId = this._frameManager.requestAnimationFrame(this._draw.bind(this)))
        }
        pause() {
            null !== this._dotLottieCore && this._dotLottieCore.pause() && this._eventManager.dispatch({
                type: "pause"
            })
        }
        stop() {
        ...
        setSpeed(t) {
            null !== this._dotLottieCore && this._dotLottieCore.setConfig({
                ...this._dotLottieCore.config(),
                speed: t
            })
        }
        setBackgroundColor(t) {
            null !== this._dotLottieCore && (this._canvas instanceof HTMLCanvasElement && (this._canvas.style.backgroundColor = t),
        ...
        freeze() {
            null !== this._animationFrameId && (this._frameManager.cancelAnimationFrame(this._animationFrameId),
        ...
        unfreeze() {
            null === this._animationFrameId && (this._animationFrameId = this._frameManager.requestAnimationFrame(this._draw.bind(this)),
            this._isFrozen = !1,
            this._eventManager.dispatch({
                type: "unfreeze"
            }))
        ...
        loadAnimation(t) {
            null !== this._dotLottieCore && (this._dotLottieCore.loadAnimation(t, this._canvas.width, this._canvas.height) ? (this._eventManager.dispatch({
                type: "load"
            }),
        ...
        setViewport(t, e, r, n) {
            return null !== this._dotLottieCore && this._dotLottieCore.setViewport(t, e, r, n)
        }
        static setWasmUrl(t) {
            c.setWasmUrl(t)
        }
    ...
    document.querySelectorAll(".contract").forEach((t => {
        ...
        e && r && r.addEventListener("click", (t => {
            t.preventDefault(),
